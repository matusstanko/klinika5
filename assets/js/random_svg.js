document.addEventListener("DOMContentLoaded", function () {
    const symbols = ["/images/zub1.svg", "/images/zub2.svg", "/images/zub3.svg", "/images/zub4.svg"]; // Your SVGs
    ...
    const teethConfig = [
        ...
        { left: "96%", top: "8%", size: "5%", rotation: 10 },
        { left: "99%", top: "18%", size: "6%", rotation: -8 },
        { left: "97%", top: "27%", size: "4.5%", rotation: 5 },
        { left: "98%", top: "37%", size: "7%", rotation: -12 },
        { left: "96%", top: "50%", size: "6%", rotation: 8 },
        { left: "99%", top: "58%", size: "5.5%", rotation: -5 },
        { left: "95%", top: "69%", size: "6.5%", rotation: 12 },
        { left: "98%", top: "80%", size: "4.8%", rotation: -10 }
    ];
