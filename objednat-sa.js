...
async function loadTimeslots() {
  try {
      const response = await fetch("https://klinika5backend-production.up.railway.app/api/get_all_timeslots");
...
async function submitReservation() {
    ...
    try {
        const response = await fetch("https://klinika5backend-production.up.railway.app/api/create_reservation", {
            method: "POST",
