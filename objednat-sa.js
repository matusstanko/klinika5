...
async function loadTimeslots() {
  try {
      const response = await fetch("klinika-web-app-g4h0frhtbzgdd6d4.germanywestcentral-01.azurewebsites.net/api/get_all_timeslots");
...
async function submitReservation() {
    ...
    try {
        const response = await fetch("klinika-web-app-g4h0frhtbzgdd6d4.germanywestcentral-01.azurewebsites.net/api/create_reservation", {
            method: "POST",
